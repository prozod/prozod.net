...
function WorkCard({ name, details, logo, year, url }: IWorkCard) {
  return (
    <a href={url} target="_blank">
      <div className="flex flex-col border-[0.5px] group  border-coal-900/10 dark:border-white/5 dark:bg-coal-800/90 rounded-md h-auto max-h-[180px] p-4 gap-4 hover:cursor-pointer dark:hover:border-white/20 hover:border-coal-900/30 transition-all">
